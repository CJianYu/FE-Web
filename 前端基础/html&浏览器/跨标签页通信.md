...
![跨页面通信实例](https://cdn.jsdelivr.net/gh/CJianYu/PictureBed/BlogImg/20210718172339.gif)
...
> 以下各种方式的 [在线 Demo 可以戳这里 >>](https://link.juejin.cn/?target=https%3A%2F%2Falienzhou.github.io%2Fcross-tab-communication%2F)

浏览器的[同源策略](https://link.juejin.cn/?target=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FSame-origin_policy)在下述的一些跨页面通信方法中依然存在限制。因此，我们先来看看，在满足同源策略的情况下，都有哪些技术可以用来实现跨页面通信。
...
此外，我还针对以上各种方式写了一个 [在线演示的 Demo >>](https://link.juejin.cn/?target=https%3A%2F%2Falienzhou.github.io%2Fcross-tab-communication%2F)

![Demo页面](https://cdn.jsdelivr.net/gh/CJianYu/PictureBed/BlogImg/20210718172457.gif)
...
![img](https://cdn.jsdelivr.net/gh/CJianYu/PictureBed/BlogImg/20210718172427)
